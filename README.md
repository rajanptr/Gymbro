...
You should be thinking about your next set.
...
- **Figma** — product & interaction design
- **AI tools** — development, exploration & prototyping
...
It's to build what actually makes the product better.
