                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        FutureBuilder<
                                          ...
                                          future:
                                              RoutineTemplatesTable().queryRows(
                                            queryFn: (q) => q
                                                .eqOrNull(
                                                  'user_id',
                                                  currentUserUid,
                                                                ...
                                                                children: [
                                                                    ...
                                                                    children: [
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            functions.capitalize(templetCreatedItem.name),
                                                                            'Workout Name',
                                                                          ),
                                                                          maxLines:
                                                                              2,
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    child: EditBottomsheetWidget(
                                                                                      templetId: templetCreatedItem.id!,
                                                                                      name: templetCreatedItem.name,
                                                                                    ),
                                                                                  ),
                                                                                ),
                                                                              );
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                          (context) {
                                                                        final exercises = containerRoutineExercisesRowList
                                                                            .map((e) =>
                                                                                e)
                                                                            .toList()
                                                                            .take(3)
                                                                          ...
                                                                          itemBuilder:
                                                                            ...
                                                                            return FutureBuilder<List<ExerciseLibraryRow>>(
                                                                              ...
                                                                              builder: (context, snapshot) {
                                                                                ...
                                                                                List<ExerciseLibraryRow> containerExerciseLibraryRowList = snapshot.data!;

                                                                                final containerExerciseLibraryRow = containerExerciseLibraryRowList.isNotEmpty ? containerExerciseLibraryRowList.first : null;
                                                                  ...
                                                                  if (((int var1) {
                                                                        return var1 >
                                                                            ...
                                                                            ? var1 -
                                                                                3
                                                                            : 0;
                                                                      }(containerRoutineExercisesRowList.length))
                                                                          .toString() !=
                                                                      '0')
                                                                    Text(
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              _model.newWorkoutSession = await WorkoutSessionsTable().insert({
                                                                                'user_id': currentUserUid,
                                                                                'title': templetCreatedItem.name,
                                                                                'notes': templetCreatedItem.notes,
                                                                                'is_completed': false,
                                                                                'template_id': templetCreatedItem.id,
                                                                                'duration_seconds': 0,
                                                                              });
                                                                              _model.templateExercises = await RoutineExercisesTable().queryRows(
                                                                                queryFn: (q) => q
                                                                                    .eqOrNull(
                                                                                      'template_id',
                                                                              ...
                                                                              for (int loop1Index = 0; loop1Index < _model.templateExercises!.length; loop1Index++) {
                                                                                final currentLoop1Item = _model.templateExercises![loop1Index];
                                                                                _model.action3 = await WorkoutExercisesTable().insert({
                                                                                  'workout_id': _model.newWorkoutSession?.id,
                                                                                  'exercise_id': currentLoop1Item.exerciseId,
                                                                                  'order_index': currentLoop1Item.orderIndex,
                                                                                });
                                                                                _model.routineSets = await RoutineSetsTable().queryRows(
                                                                                  queryFn: (q) => q
                                                                                      .eqOrNull(
                                                                                        'routine_exercise_id',
                                                                                        currentLoop1Item.id,
                                                                                ...
                                                                                if (_model.routineSets != null && (_model.routineSets)!.isNotEmpty) {
                                                                                  for (int loop2Index = 0; loop2Index < _model.routineSets!.length; loop2Index++) {
                                                                                    final currentLoop2Item = _model.routineSets![loop2Index];
                                                                                    await ExerciseSetsTable().insert({
                                                                                      'workout_exercise_id': _model.action3?.id,
                                                                                      'set_number': currentLoop2Item.setNumber,
                                                                                      'is_warmup': false,
                                                                                      'completed': false,
                                                                                      'weight': 0.0,
                                                                                      'reps': 0,
                                                                            ...
                                                                            text:
                                                                                valueOrDefault<String>(
                                                                              functions.capitalize('Start Exercise'),
                                                                              'Start Exercise',
                                                                            ),
                                                                            options:
                                                                                FFButtonOptions(
