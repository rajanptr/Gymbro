  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case CompletedWorkoutsRow:
            return CompletedWorkoutsRow(data);
          case ExerciseLibraryRow:
            return ExerciseLibraryRow(data);
          case ExerciseProgressRow:
            return ExerciseProgressRow(data);
          case ExerciseSetHistoryRow:
            return ExerciseSetHistoryRow(data);
          case ExerciseSetsRow:
            return ExerciseSetsRow(data);
          case MuscleFrequencyRow:
            return MuscleFrequencyRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case RoutineExercisesRow:
            return RoutineExercisesRow(data);
          case RoutineSetsRow:
          ...
          case WaterLogsRow:
            return WaterLogsRow(data);
          case WaterTodaySummaryRow:
            return WaterTodaySummaryRow(data);
          case WorkoutExerciseDetailsRow:
            return WorkoutExerciseDetailsRow(data);
          case WorkoutExercisesRow:
            return WorkoutExercisesRow(data);
          case WorkoutSessionsRow:
            return WorkoutSessionsRow(data);
          default:
            return null;
        }
